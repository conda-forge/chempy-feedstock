...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/chempy-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=11396&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/chempy-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `chempy` can be installed with:

```
conda install chempy
```

It is possible to list all of the versions of `chempy` available on your platform with:
